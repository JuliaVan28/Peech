...
class Camera: NSObject {
    ...
    func start() async {
        ...
        sessionQueue.async { [self] in
            if captureDevice == nil {
                logger.info("captureDevice is nill")
    ...
    func takePhoto() {
        guard let photoOutput = self.photoOutput else { logger.error("couldn't unwrap photoOutput")
            return }
        
        sessionQueue.async {
        
            var photoSettings = AVCapturePhotoSettings()
            logger.info("setting photo settings")
            ...
            logger.info("about to capture photo")
...
extension Camera: AVCapturePhotoCaptureDelegate {
    ...
    func photoOutput(_ output: AVCapturePhotoOutput, didFinishProcessingPhoto photo: AVCapturePhoto, error: Error?) {
        ...
        logger.info("adding photoOutput to photo Stream")
